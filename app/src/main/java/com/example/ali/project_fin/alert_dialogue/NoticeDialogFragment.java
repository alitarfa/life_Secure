...
public class NoticeDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.password_alert_dialogue, null);
        ...
        builder.setMessage("enter the pass")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        EditText editText2 = (EditText) view.findViewById(R.id.a);
                        String p2 = editText2.getText().toString();

                          checked=false;

                           mListener.onDialogPositiveClick(NoticeDialogFragment.this, p1, p2,checked);
